...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    PrintStream out=null;
      try{
          if(args.length>0){
                out=new PrintStream(new FileOutputStream(args[0], true));
  ...
  // wait until all are finished
          ...
          if((less==true)&&(more==true))out.println(" There is amount with more than 300and there is amount with less than 300, No Lock>");
          if((less==false)&&(more==true))out.println(" There is amount with more than 300, No Lock>");
          if((less==true)&&(more==false))out.println(" There is amount with less than 300, No Lock>");
          if((less==false)&&(more==false))out.println(" All amounts are 300,None>");
          out.close();
    }
